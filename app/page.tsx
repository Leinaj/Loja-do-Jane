...
export default function Page() {
  ...
  const copyPix = async () => {
    try {
      ...
      alert('Copie manualmente: ' + PIX_KEY);
    }
  };
    ...
    <main className="min-h-screen bg-neutral-950 text-neutral-200">
      ...
      <div className="text-xs sm:text-sm bg-neutral-900 text-neutral-400 border-b border-neutral-800">
        <div className="max-w-6xl mx-auto px-4 py-2 flex flex-wrap gap-x-6 gap-y-1 justify-between">
          ...
          <div className="flex gap-4">
            <span>
              Suporte: WhatsApp{' '}
              <a className="text-emerald-400 underline" href={`https://wa.me/${WHATSAPP_RAW}`} target="_blank">
                {WHATSAPP_DISPLAY}
              </a>
            </span>
            <span>
          ...
          <div className="grid sm:grid-cols-2 gap-6 items-center">
            ...
            <div>
              ...
              <p className="text-neutral-400 mt-2">
                ...
                <code className="px-1 py-0.5 rounded bg-neutral-800 text-neutral-300">/public/banner.jpg</code>.
              </p>
                  ...
                  <li key={product.id} className="py-3 flex items-center justify-between">
                    <div>
                      ...
                      <div className="text-neutral-400 text-sm">
                        {qty} x {currency.format(product.price)} ={' '}
                        <b className="text-neutral-200">{currency.format(line)}</b>
                      </div>
                    </div>
      ...
      <section id="contato" className="max-w-6xl mx-auto px-4 mt-10">
        ...
        <div className="rounded-2xl border border-neutral-800 bg-neutral-900 p-4">
          ...
          <a className="block text-emerald-400 underline" href={`https://wa.me/${WHATSAPP_RAW}`} target="_blank">
            {WHATSAPP_DISPLAY}
          </a>
          <div className="mt-4">
